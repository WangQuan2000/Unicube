                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 d-flex justify-content-center">
                         ...
                         <div class="row" style="font-size:18px;">
	                         <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 d-flex justify-content-center"><a href="Redirect_Login" style="color:#00b373">账号密码登录</a></div>
	                         <div  class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 d-flex justify-content-center"><a href="Redirect_LoginViaPhone" style="color:#9e9e9e">短信验证码登录</a></div>
                         </div>
                         <hr/>
						<form method="POST" action="LoginByUserName">
						  <div class="form-group">
						    <label for="exampleInputEmail1">号码/邮箱</label>
						    <input type="email" name="username" class="form-control" style="border:1px solid #e0e0e0" placeholder="请输入用户名或邮箱">
						  </div>
						  <div class="form-group">
						    <label for="exampleInputPassword1">密码</label>
						    <input type="password" name="password" class="form-control" style="border:1px solid #e0e0e0" placeholder="请输入密码">
						  </div>
						  <div class="form-check row d-flex">
						    ...
						    <label class="form-check-label" for="exampleCheck1"><a href="Redirect_ForgetPassword" style="align:right;color:#00b373">忘记密码?</a></label>
						    </div>
						  </div>
