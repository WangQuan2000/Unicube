                ...
                <div class="container" style="padding: 64px 0px">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 d-flex justify-content-center">
                          <img src="images/banner-img.jpg" style="height:550px;border-radius:16px;">
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 d-flex justify-content-center">
                         <div style="height:550px;width:100%;border-radius:16px;box-shadow: 2px 2px 16px 0 rgba(0, 0, 0, 0.1);padding:32px 24px;">
                         <h2>注册</h2>
						<form method="POST" action="Register">
						    <label>手机</label>
						  <div class="form-row">
						    <div class="form-group col-md-4">
                            <input type="text" class="form-control" style="border:1px solid #e0e0e0;background-color:white" value="中国(+86)" disabled>
                            </div>
                            <div class="form-group col-md-8">
						    <input type="text" name="phone" class="form-control" style="border:1px solid #e0e0e0" placeholder="请输入手机号码">
						    </div>
						  </div>
						  <div class="form-group">
                            <label>设置密码</label>
                            <input type="password" name="password" class="form-control" style="border:1px solid #e0e0e0" placeholder="建议至少使用两种字符组合">
						  </div>						  
                            <label>验证码</label>
						  <div class="form-row">
						   <div class="form-group col-md-8">
                            <input type="text" name="password" class="form-control" style="border:1px solid #e0e0e0" placeholder="请输入验证码">
						  </div>
						  <div class="form-group col-md-4">
						  ...
						  <div class="form-check">
						    ...
						    <label class="form-check-label" for="exampleCheck1">我已阅读并同意注册条款</label>
						  </div>
						  <button style="background-color:#00b373;color:white;border:none;margin-top:16px" type="submit" class="btn btn-primary btn-lg btn-block">注册</button>
						</form>
					     <div style="text-align:center;margin-top:18px;">还没有账号? <a href="Redirect_Login" style="color:#00b373">立即登录</a></div>
                         </div>
                        </div>
