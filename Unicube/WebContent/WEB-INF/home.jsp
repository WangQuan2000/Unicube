...
<%@page import="com.Unicube.model.Case" %>
<!doctype html>
<html lang="en">
...
%>
    ...
    <div class="wrapper">
        ...
        <main>
            <!--            -->
            <div class="banner oval d-flex align-items-center orange-bg">
                <div class="container">
                    <div class="row">
            ...
            <section class="popular_major_sec py-5">
                <div class="container">
                    ...
                    <div class="row image_block_row">
                        <div class="col-xl-6 col-lg-6 col-md-4 col-sm-12 col-12 image_box">
                            <div class="image_block backbgbox d-flex align-items-end justify-content-center">
                                <img src="images/img1.jpg" alt="" class="backbg">
                                <h4>更多专业点这里查看</h4>
                                <a href="Major_List" class="anchour">anchour</a>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-8 col-lg-8 col-md-7 col-sm-12 col-12">
                            <div class="student_info_left">
                                <h6><%=cases[0].getRemark() %></h6>
                                <p><%=cases[0].getTitle() %></p>
                                <h4><%=cases[0].getCustomerName() %></h4>
                                <h5><%=cases[0].getDegree().getName() %>, <%=cases[0].getCustomerSchool() %></h5>
                                <ul class="list_btn">
                            ...
                            <%for(int i=0;i<mentors.length;i++){ %>
                                <div class="item">
                                    <div class="team_box text-center">
                                        <figure><img src="http://stg.unicube.tk<%=mentors[i].getProfilePicture().getUrl() %>" alt=""></figure>
                                        <h5><%=mentors[i].getName() %></h5>
                                        <h6><%=mentors[i].getTags() %> </h6>
                                        <a href="Mentor_Details?id=<%=mentors[i].getId() %>" class="anchour">anchour</a>
                                    </div>
                                </div>
                             <%} %>  
                            </div>
                            <a href="Mentor_List" class="anchour_text">更多院校点这里查看</a>
                        </div>
                    </div>
                </div>
            </section>
