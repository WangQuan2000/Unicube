...
<div class="container-fluid customer-details-body">
  ...
  <nav id="sidebarMenu" class="col-md-2 d-md-block  collapse customer-details-body-menu">
    ...
    <nav role="main" class="col-md-8">
		  ...
		  <a href="Customer_Favourite" style="font-size:18px !important;line-weight:1.33;padding:0px 15px">学校</a>
          ...
          <a style="font-size:18px !important;line-weight:1.33;color:#00b373;padding:0px 15px">问答</a>
          <hr>
		   ...
		   <table class="application-table col-md-12">
		    ...
		    <%for(int i=0;i<10;i++){ %>
		      <tr>
		        <td style="color:#05af78"><a>荷兰什么专业好</a></td>
		        <td>{二级分类}</td>
		        <td>2020-01-09</td>
		      </tr>	
		      <%} %>      		      		      		      
