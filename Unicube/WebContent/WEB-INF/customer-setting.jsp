  ...
  <nav id="sidebarMenu" class="col-md-2 d-md-block  collapse customer-details-body-menu">
      ...
      <hr>
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="Customer_Setting" style="color:#05af78">       
		   ...
		   <table class="application-table col-md-12">
		    <tbody>
		      <tr>
		        <td>头像</td>
		        <td>          
		        <svg class="bd-placeholder-img rounded-circle" width="35" height="35" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img">
                 <title>Placeholder</title><rect width="100%" height="100%" fill="#777"/><text x="50%" y="50%" fill="#777" dy=".3em">140x140</text>
                </svg></td>
		        <td></td>
		        <td></td>
		        <td></td>
		        <td style="color:#05af78"><a>修改</a></td>
		      </tr>	
    		  <tr>
		        <td>用户名</td>
		        <td>Wendy</td>
		       ...
		       <tr>
		        <td>邮箱</td>
		        <td>1738939393@qq.com</td>
		        <td></td>
		        <td></td>
		        <td></td>
		        <td style="color:#05af78"><a>去绑定</a></td>
		      </tr>	
		      <tr>
		        <td>密码</td>
		        <td>******</td>
