                    ...
                    <div class="row">
						...
						<form method="POST" action="LoginByUserName">
						  <div class="form-group">
						    <label>Please enter your phone number to reset your password.</label>
						  </div>
						  <div class="form-group">
						    <label for="exampleInputPassword1">手机</label>
						    <input type="text" name="phone" class="form-control" style="border:1px solid #e0e0e0" placeholder="请输入手机">
						  </div>
						  <div class="form-group">
						  <button style="background-color:#00b373;color:white;border:none;margin-top:16px;padding:12px 28px;margin-right:12px;border-radius:8px;" type="submit">确认</button>
						  <button style="background-color:white;color:#00b373;border:1px solid #00b373;margin-top:16px;padding:12px 28px;border-radius:8px;" type="submit">取消</button>
						  </div>
						</form>
                         </div>
                        </div>
