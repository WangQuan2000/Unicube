  ...
  <nav id="sidebarMenu" class="col-md-2 d-md-block  collapse customer-details-body-menu">
      ...
      <hr>
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="Customer_Details" style="color:#05af78">
    ...
    <nav role="main" class="col-md-8">
		  <div style="font-size:21px;font-weight:bold;line-height:1.52;">
				用户中心
			</div>
		  <div class="customer-details-newslist" style="min-height:700px;padding:30px 30px">
		  <div class="row">
          <div style="font-size:18px;line-height:1.33;font-weight:bold">我的服务</div>
          <div class="col-md-12" style="background-color:#f5f5f5;margin:20px 0px;padding:20px 10px;height:132px;border-radius:8px;text-align:center;">
             <div style="font-size:18px;line-height:1.33;margin:10px 20px;">您还没有购买任何服务呢</div>
             <button type="submit" style="color:white;background-color:#05af78;border:none;padding: 12px 12px;border-radius:8px;font-size:14px;line-height:1.71">立即购买</button>
          </div>
          <div class="col-md-12" style="font-size:14px;background-color:#bca360;margin:20px 0px;padding:20px 10px;font-weight:bold;line-height:1.71;color:white;border-radius:8px">金牌套餐</div>
          <div style="font-size:18px;line-height:1.33;font-weight:bold">我的申请</div>
          ...
          <div class="col-md-12" style="margin:10px 0px;text-align:center">
             <button type="submit" style="color:white;background-color:#05af78;border:none;padding: 12px 15px;border-radius:8px;font-size:14px;line-height:1.71">评价服务</button>
          </div>
          </div>
		  </div>
    </nav>
