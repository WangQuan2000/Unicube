...
public class Mentor_DocterSchool {
	private int id;
	private String Name;
	...
	Mentor_DocterSchool_Badge Badge;
	...
	public Mentor_DocterSchool_Badge getBadge() {
		return Badge;
	}

	public void setBadge(Mentor_DocterSchool_Badge badge) {
		Badge = badge;
	}
