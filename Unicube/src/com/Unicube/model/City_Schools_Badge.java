...
public class City_Schools_Badge {
	private int id;
	private String name;
	...
	City_Schools_Badge_Format formats;
	private String hash;
	private String ext;
	private String mime;
	private float size;
	...
	public City_Schools_Badge_Format getFormats() {
		return formats;
	}

	public void setFormats(City_Schools_Badge_Format formats) {
