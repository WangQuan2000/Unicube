...
public class Program_School_Badge {
	private int id;
	private String name;
	...
	Program_School_Badge_Formats formats;
	private String hash;
	private String ext;
	private String mime;
	private float size;
	...
	public Program_School_Badge_Formats getFormats() {
		return formats;
	}

	public void setFormats(Program_School_Badge_Formats formats) {
