...
public class City_Pictures {
	...
	City_Pictures_Format FormatsObject;
	private String hash;
	private String ext;
	private String mime;
	private float size;
	...
	public City_Pictures_Format getFormatsObject() {
		return FormatsObject;
	}

	public void setFormatsObject(City_Pictures_Format formatsObject) {
