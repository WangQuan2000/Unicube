...
public class Mentor_ProfilePicture {
	private float id;
	private String name;
	...
	Mentor_ProfilePicture_Formats formats;
	private String hash;
	private String ext;
	private String mime;
	private float size;
	...
	public Mentor_ProfilePicture_Formats getFormats() {
		return formats;
	}

	public void setFormats(Mentor_ProfilePicture_Formats formats) {
